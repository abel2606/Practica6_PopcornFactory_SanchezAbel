...
class PeliculaAdapter : BaseAdapter{
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        val iv_pelicula: ImageView = vista.findViewById(R.id.iv_pelicula)
        val tv_nombre_pelicula: TextView = vista.findViewById(R.id.tv_nombre_pelicula)

        iv_pelicula.setImageResource(pelicula.imagen)
        tv_nombre_pelicula.setText(pelicula.titulo)
